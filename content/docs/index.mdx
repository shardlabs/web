...
import { BotIcon, DownloadIcon, LineChartIcon, TableIcon } from 'lucide-react';
...
<Cards >
<Card icon={<TableIcon />} href="/docs/tables"  title="Tables">
Create and manage SQLite tables with a visual interface. Add rows, edit cells, paginate through data, and filter with a query builder.
</Card>

<Card icon={<BotIcon />} href="/docs/automations"  title="Automations">
Build event-driven workflows that trigger actions when your data changes. Send webhooks, create rows, and chain complex logic using visual rules.
</Card>

<Card icon={<LineChartIcon />} href="/docs/charts"  title="Charts">
Visualize your data with line charts. Track metrics over time, compare multiple series, and monitor trends in real-time.
</Card>

<Card icon={<DownloadIcon />} href="/docs/export"  title="Export">
Back up your entire Shard as a SQL file. Export your data at any time for safekeeping or migration.
</Card>
