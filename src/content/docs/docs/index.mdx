...
Shard is a new kind of data workspace: part terminal, part dashboard, part playground. It pairs managed Postgres databases (one per Shard) with a modern visual interface for managing tables, creating automations, and building charts. You can provision a cloud shard or bring your own Postgres soon.
...
<CardGrid >
<LinkCard href="/docs/how-to/tables"  title="Tables" description='Create and manage tables with a visual interface. Add rows, edit cells, paginate through data, and filter with a query builder. Backed by Postgres.' />
...
<LinkCard href="/docs/how-to/export"  title="Export" description='Back up your entire Shard as a Postgres‑compatible SQL file. Export your data at any time for safekeeping or migration.' />
